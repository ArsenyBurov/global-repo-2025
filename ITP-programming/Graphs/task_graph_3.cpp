...
//Подсчитать полустепень исхода каждой вершины.
#include <iostream>
#include <vector>
...
void result(const vector<vector<int>>& Gr) {
    cout <<endl<< "полустепени исхода каждой вершины:" << endl;
    for (int i = 0; i < Gr.size(); ++i) {
        cout << "вершина " << i << ": " << Gr[i].size() << endl;
    }
}
